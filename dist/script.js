...
var modals = function modals() {
  var btnPressed; // буде змінюватись, коли користувач натисне на якийсь тригер

  function bindModal(triggerSelector, modalSelector, closeSelector) // при виклику модального вікна тригер зникає
  {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener("click", function () {
    Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["getResource"])("http://localhost:3000/styles").then(function (res) {
